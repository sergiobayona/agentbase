...
RSpec.describe AgentBase::AgentGenerator, type: :generator do
  ...
  context 'with a simple name' do
    ...
    it 'creates the agent with correct content' do
  ...
  context 'with a namespaced name' do
    ...
    it 'creates the agent file in the correct directory' do
      assert_file 'app/agents/support/customer_agent.rb'
    end

    it 'creates the agent with correct namespacing and content' do
