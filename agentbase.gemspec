...
Gem::Specification.new do |spec|
  ...
  spec.summary =
    "AgentBase: A Ruby library for building text-to-action LLM applications."
  spec.description =
    "AgentBase: A Ruby library for building text-to-action LLM applications."
  ...
  spec.metadata[
    "source_code_uri"
  ] = "https://github.com/sergiobayona/agent_base"
  spec.metadata[
    "changelog_uri"
  ] = "https://github.com/sergiobayona/agent_base/blob/main/CHANGELOG.md"
